...
## Necessary steps
Create a replit account from [here](https://replit.com/). Now fork this git from [here](https://replit.com/github/Catspindev/Urlshort).
## How to setup
...
https://github.com/Catspindev/Urlshort
